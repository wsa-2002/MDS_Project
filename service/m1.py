...
class M1Model:
    def __init__(self):
        ...
        df = pd.read_excel('data/m1_data_no_outlier.xlsx')
        ...
        This = Regression.Regression_G(df_train, target_title={'y': 'kWh', 'x1': 'index', 'x2': '平均測站氣溫'},
                                       ...
                                       interaction=[['Covid_All', '平均測站氣溫'], ['time_3', '平均測站氣溫'], ['time_7', '平均測站氣溫'], ['time_2', '平均測站氣溫'], ['time_8', '平均測站氣溫'], ['time_1', '平均測站氣溫'], ['WORK', '平均測站氣溫']])
        plt.rcParams["figure.figsize"] = (25, 20)
        This.line(sep=False, fontsize=10, spot=8)

        interaction = [['Covid_All', '平均測站氣溫'], ['time_3', '平均測站氣溫'], ['time_7', '平均測站氣溫'], [
            'time_2', '平均測站氣溫'], ['time_8', '平均測站氣溫'], ['time_1', '平均測站氣溫'], ['WORK', '平均測站氣溫']]
        ...
        df_forcast['mse'] = (df_forcast['true'] - df_forcast['predict'])**2
        df_forcast['mad'] = abs(df_forcast['true'] - df_forcast['predict'])
        MSE = df_forcast['mse'].mean()
        MAD = df_forcast['mad'].mean()
